...
import { Button, Menu, Text } from '@nayeshdaggula/tailify';
                                                ...
                                                >
                                                    {
                                                        item.file_type !== 'folder' ? (
                                                            <>
                                                                {permissions?.flats_page?.includes("view_file_in_flat") && (
                                                                    <Menu.Item
                                                                ...
                                                                {permissions?.flats_page?.includes("delete_file_in_flat") && (
                                                                    <Menu.Item
                                                                        color="red"
                                                            ...
                                                            (
                                                                ...
                                                                <>
                                                                    {permissions?.flats_page?.includes("delete_folder_in_flat") && (
                                                                        <Menu.Item
                                                                            color="red"
