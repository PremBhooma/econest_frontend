...
import { Textinput, Select, Loadingoverlay, Datepicker } from "@nayeshdaggula/tailify";

function Convertleadtocustomerwrapper() {
            ...
            <div className="flex flex-col gap-4 border border-[#ebecef] rounded-xl bg-white p-8">
                ...
                <div className="flex justify-end mt-auto">
                    <Link
                        ...
                        className="cursor-pointer text-sm text-white px-4 py-2 rounded bg-[#0083bf]"
                    >
...
export default Convertleadtocustomerwrapper;
