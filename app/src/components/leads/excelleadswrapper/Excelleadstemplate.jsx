...
function Excelleadstemplate({ closeDownloadTemplate }) {
    ...
    const downloadLeadTemplate = async () => {
        ...
        const leadStatusOptions = ["Warm", "Cold"];
        const bedroomOptions = ["2 BHK", "3 BHK"];
        const purposeOptions = ["Enduse", "Investment"];
        const fundingOptions = ["Homeloan", "Bankloan"];
        ...
        for (let i = 2; i <= rowCount; i++) {
            ...
            worksheet.getCell(`G${i}`).dataValidation = {
                ...
                error: "Please select Warm or Cold.",
            };
            ...
            worksheet.getCell(`L${i}`).dataValidation = {
                ...
                error: "Please select Homeloan or Bankloan.",
            };
        }
    ...
    return (
        <div className="text-sm space-y-2 p-4">
            ...
            <ul className="list-decimal ml-5 space-y-1">
                ...
                <li><strong>Lead Status:</strong> Select from dropdown (Warm, Cold).</li>
                ...
                <li><strong>Funding:</strong> Select from dropdown (Homeloan, Bankloan).</li>
