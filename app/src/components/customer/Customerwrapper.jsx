...
function Customerwrapper() {
  ...
  const updateSortby = useCallback(
    (data) => {
      setSortby(data);
      GetAllCustomers(page, limit, searchQuery, sortbyType, data);
    },
  ...
  const updateSortbyType = useCallback(
    (data) => {
      setSortbyType(data);
      GetAllCustomers(page, limit, searchQuery, data, sortby);
    },
  ...
  const updateSearchQuery = useCallback(
    (e) => {
      ...
      GetAllCustomers(page, limit, e.target.value, sortbyType, sortby);
    },
  ...
  const updateLimit = useCallback(
    (data) => {
      ...
      setLimit(data);
      setPage(newpage);
      GetAllCustomers(newpage, data, searchQuery, sortbyType, sortby);
    },
  ...
  useEffect(() => {
    setIsLoading(true);
    GetAllCustomers(page, limit, searchQuery, sortbyType, sortby);
  ...
  const handleDateFilterChange = (newDateRange) => {
    ...
    setPage(1);
    setIsLoading(true);
    GetAllCustomers(1, limit, searchQuery, sortbyType, sortby);
  };
