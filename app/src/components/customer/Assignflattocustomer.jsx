...
import { Textinput, Loadingoverlay, Datepicker, Button } from "@nayeshdaggula/tailify";
    ...
    return (
        <>
            <div className="flex justify-between items-center px-4 py-2">
                <p className="font-semibold text-lg">Assign Flat to Customer</p>
                <Button
            ...
            <div className="flex gap-3 w-full px-4 py-2">
                ...
                <div className="relative border border-[#ced4da] p-3 w-[60%] rounded-md">
