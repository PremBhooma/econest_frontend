...
import { Loadingoverlay, Datepicker } from "@nayeshdaggula/tailify";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { IconX } from "@tabler/icons-react";

function Assignflattocustomer({ closeAssignFlatToCustomer, customerUuid }) {
    ...
    useEffect(() => {
        if (totalCostofUnit) {
            ...
            if (saleableAreaSqFt) {
                ...
                setGrandTotal(parseFloat(totalCostofUnit) + parseFloat(gstValue) + parseFloat(maintainCharge) + parseFloat(corpusFund) + parseFloat(documentationFee) + parseFloat(manjeeraConnectionCharge))
            }
        } else {
            setGst("");
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-end bg-black/50 backdrop-blur-[2px]" onClick={closeAssignFlatToCustomer}>
            <div
